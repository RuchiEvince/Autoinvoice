...
class Data
{
    ...
    CONST ENABLED_FOR_STORES = 'mercuriel/general/enable_for_stores';
...
*/
    ...
    {
        $storeIdString = $this->scopeConfig->getValue(self::ENABLED_FOR_STORES);
        if(!empty($storeIdString))
        {
            return explode(",",$storeIdString);
        }
